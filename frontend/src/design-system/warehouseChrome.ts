...
export const warehouseRailBgClass = colors.surface.rail;

export const warehouseLeftRailClass = [
  "flex h-full min-h-0 flex-none flex-col self-stretch overflow-hidden overscroll-y-contain",
  "border-r",
...
export const warehouseRightRailShellClass = [`!bg-[#f7f8fa]`, shadows.rail].join(" ");
