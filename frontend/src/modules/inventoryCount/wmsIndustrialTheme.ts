...
export const WMS_INV = {
  ...
  inputTerminal:
    "w-full rounded-lg border border-[#c8ced8] bg-white py-2.5 pl-3 pr-3 text-base font-semibold text-[#1a2b3c] placeholder:text-[#a0aec0] focus:border-[#1e4d8c] focus:outline-none focus:ring-1 focus:ring-[#1e4d8c]/30",
  btnCompact:
    "rounded-md border border-[#d0d7e2] bg-white px-2.5 py-1 text-xs font-bold text-[#1a2b3c] active:bg-[#f0f2f5]",
  btnQuick:
    "min-h-[40px] rounded-md border border-[#d0d7e2] bg-white text-xs font-bold text-[#1a2b3c] active:bg-[#eef1f5]",
  btnFooter:
    "min-h-[48px] rounded-lg border border-[#d0d7e2] bg-white px-1 text-[11px] font-bold leading-tight text-[#1a2b3c] active:scale-[0.98]",
  btnPrimary:
