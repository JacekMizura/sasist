...
export function useOperationalRuntime(opts?: { enabled?: boolean }) {
  ...
  return {
    ...
    backendReachable: features.backendReachable,
    directSalesFlag: features.directSalesFlag,
    directSalesEnabled: features.directSalesEnabled,
    directSalesSearchEnabled: features.directSalesSearchEnabled,
    runtimeFlag: features.runtimeFlag,
    replenishmentFlag: features.replenishmentFlag,
    replenishmentEnabled: features.replenishmentEnabled,
    unavailableReason: features.unavailableReason,
    rawFeaturePayload: features.rawPayload,
    blockedEndpoints: features.blockedEndpoints,
    health,
    events,
    lastEventId,
    connected,
