...
const UI_STRINGS_DEFAULTS = {
  ...
  warehouse: {
    ...
    rackSidebar: {
      ...
      gapCm: "Odstęp (cm):",
      deleteTemplateConfirm: "Usunąć szablon? Regały na planie pozostaną.",
      dm3: "dm³",
      newTemplate: "Nowy szablon",
      rackList: "Lista regałów",
      noRacks: "Brak regałów",
      dragOntoPlan: "",
      noTemplatesHint: "Brak szablonów.",
      rowToolHint: "",
      saveLayout: "Zapisz",
      saving: "Zapisywanie…",
    },
    export: {
      ...
      csv: "CSV",
      json: "JSON",
      pdfFailed: "Nie udało się pobrać raportu.",
    },
    rackProperties: {
      title: "Właściwości",
