/** Tokeny tabeli zamówień towaru — nagłówek z moduleList SSOT. */
...
export const poListThClass = moduleListStickyThClass;
...
export const poListNameThClass = moduleListStickyNameThClass;
...
export const poListActionsThClass = `${moduleListStickyActionsThBase} w-[184px] min-w-[184px] max-w-[184px]`;
...
export const poListPosThClass = `${moduleListStickyThRightClass} w-[52px] min-w-[52px] max-w-[52px] shrink-0 px-2`;
