export const productsListTableClass = "w-full table-fixed text-left text-sm";
...
export const productsListCheckboxThClass =
...
export const productsListPhotoCellClass =
  "box-border w-[80px] min-w-[80px] max-w-[80px] shrink-0 px-2 py-0 align-middle text-center";
export const productsListPhotoThClass =
  "sticky top-0 z-10 box-border w-[80px] min-w-[80px] max-w-[80px] shrink-0 bg-white px-2 py-3 text-center text-[11px] font-semibold uppercase tracking-wide text-slate-500 shadow-[inset_0_-1px_0_0_rgb(226,232,240)]";

export const productsListNameCellClass = "min-w-0 px-4 py-0 align-middle text-sm leading-snug text-slate-800";
export const productsListNameThClass =
...
export const productsListSortableThClass =
  "cursor-pointer select-none hover:bg-slate-50/80 transition-colors";

export const productsListThRightClass = `${productsListThClass} text-right`;
