  ...
  return (
    ...
    >
      <div className="flex flex-1 min-h-0 flex-col overflow-hidden">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-4 pb-5 pt-3 flex flex-col gap-2.5">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="relative w-12 h-12 shrink-0 overflow-hidden rounded-lg bg-slate-700/80">
