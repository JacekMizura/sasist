...
export default function NotificationBell({ count, to = "/dashboard" }: Props) {
  ...
  return (
    <Link
      ...
      title={label}
      aria-label={label}
      className="relative inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl text-[#64748B] transition-colors duration-150 ease-out hover:bg-[#EFF6FF] hover:text-[#0F172A] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2563EB]"
    >
