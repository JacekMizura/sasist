    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div className="space-y-6 lg:col-span-8">
          <OrderDetailSectionCard title="Dopasowane opakowania" right={<Link to={WMS_ROUTES.packingOrder(order.id)} className="text-slate-400 hover:text-slate-800 transition-colors"><Pencil className="h-4 w-4" strokeWidth={2}/></Link>}>
