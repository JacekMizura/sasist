...
export default function OrderCustomFieldIconPicker({
  ...
  return (
    <div className="space-y-2">
      ...
      {pickerOpen ? (
        <div className="space-y-2 rounded-lg border border-slate-200/70 bg-slate-50/50 p-2.5">
          <div
            className="inline-flex rounded-md border border-slate-200/90 bg-slate-100/90 p-0.5"
            role="tablist"
                ...
                <>
                  ...
                  >
                    ...
                    <span className="min-w-0 text-slate-800">
                      ...
                      <span className="text-slate-500"> · PNG, JPG, SVG, WEBP · możesz też upuścić</span>
                    </span>
                  </button>
                  ...
                  <p className="text-[10px] leading-snug text-slate-500">
                    Podgląd dopasowuje obraz w kwadracie 48×48 (contain, bez rozciągania).
                  </p>
                </>
              )}
          ...
          {tab === "url" ? (
            <div className="space-y-1">
              ...
              />
              <p className="text-[10px] text-slate-500">HTTPS. Podgląd w polu powyżej — zapis po wyjściu z pola.</p>
            </div>
          ) : null}
        </div>
      ) : null}
