...
export const stBtnDanger =
  "inline-flex h-9 shrink-0 items-center justify-center rounded-lg border border-red-200 bg-white px-3 text-sm font-medium text-red-800 shadow-sm hover:bg-red-50 disabled:opacity-40";
export const stIconBtn =
  "inline-flex h-8 w-8 items-center justify-center rounded-md border border-slate-200 bg-white text-slate-600 shadow-sm hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-30";
export const stCard = "overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm";
