/**
 * Tokeny tabeli listy producentów — nagłówek z moduleList SSOT.
 */
import {
...
export const manufacturersListThClass = moduleListStickyThClass;
...
export const manufacturersListCheckboxThClass = moduleListStickyCheckboxThClass;
...
export const manufacturersListLogoThClass = moduleListStickyPhotoThClass;

export const manufacturersListNameCellClass = "min-w-0 px-4 py-0 align-middle text-sm leading-snug text-slate-800";
export const manufacturersListNameThClass = moduleListStickyNameThClass;
...
export const manufacturersListActionsThClass = `${moduleListStickyActionsThBase} w-[88px] min-w-[88px] max-w-[88px] text-left`;
