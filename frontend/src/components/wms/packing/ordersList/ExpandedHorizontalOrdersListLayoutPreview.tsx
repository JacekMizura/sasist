...
function PreviewCard({
  ...
  return (
    ...
    >
      <div className="flex w-max max-w-full flex-wrap items-start gap-x-2 gap-y-1">
        <div>
          <div className={labelCls}>Nr zamówienia</div>
          <div className="mt-0.5 text-base font-extrabold tabular-nums leading-none text-slate-900">{number}</div>
        </div>
        <div>
