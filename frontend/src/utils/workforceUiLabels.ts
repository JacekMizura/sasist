...
const MODULE_LABELS: Record<string, string> = {
  ...
  WMS_PRODUCTION: "WMS — Produkcja",
  WMS_MOVEMENTS: "WMS — Przesunięcia",
  WMS_CARRIERS: "WMS — Nośniki",
  WMS_BRAKI: "WMS — Braki",
  WMS_PICKING: "WMS — Kompletacja",
  WMS_PACKING: "WMS — Pakowanie",
  WMS_RELOCATION: "WMS — Rozlokowanie",
  WMS_REPLENISHMENT: "WMS — Uzupełnienia",
  WMS_INVENTORY: "WMS — Inwentaryzacja",
  WMS_RETURNS: "WMS — Zwroty",
  INVENTORY: "Inwentaryzacja ERP",
  INVENTORY_WMS: "Inwentaryzacja WMS",
  STOCK_DOCUMENTS: "Dokumenty magazynowe",
  SALE_DOCUMENTS: "Dokumenty sprzedaży",
  DOCUMENTS: "Generowanie dokumentów",
  DOCUMENT_SERIES: "Serie dokumentów",
  DIRECT_SALES: "Sprzedaż bezpośrednia",
  OPERATIONS: "Operacje magazynowe",
  PRODUCTION: "Produkcja",
  ORDERS: "Zamówienia",
  PURCHASING: "Zakupy",
  SUPPLIER_ORDERS: "Zamówienia u dostawców",
  INBOUND: "Przyjęcia",
  RETURNS: "Zwroty",
  ...
  PICKING: "Kompletacja",
  WAVE: "Fale kompletacji",
  SCAN: "Skanowanie",
  REPORTS: "Raporty",
  EXPORT: "Eksport",
  IMPORT: "Import",
  ADMIN_USERS: "Administracja — użytkownicy",
  AUTH: "Logowanie",
  WORKFORCE: "Zespół / czas pracy",
  SETTINGS: "Ustawienia",
  TENANT: "Organizacja",
  SYSTEM: "System",
  LABELS: "Etykiety",
  ...
  CUSTOMERS: "Klienci",
  SUPPLIERS: "Dostawcy",
  API: "Niesklasyfikowane (historyczne)",
  UNKNOWN: "Niesklasyfikowane",
  HEALTH: "Monitoring",
  OPERATIONAL_RUNTIME: "Runtime operacyjny",
  WMS_DASHBOARD: "WMS — pulpit",
  wms_receiving: "WMS — Przyjęcie",
  wms_production: "WMS — Produkcja",
  wms_putaway: "WMS — Rozlokowanie PZ",
  wms_movements: "WMS — Przesunięcia",
