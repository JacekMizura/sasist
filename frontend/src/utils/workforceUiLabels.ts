...
const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  "WMS_PUTAWAY.putaway_finish": "Zakończono rozlokowanie",
...
const ACTIVITY_ACTION_LABELS: Record<string, string> = {
  ...
  scan_carrier_putaway: "Rozlokowanie nośnika",
  scan_product_putaway: "Rozlokowanie produktu",
  putaway_finish: "Koniec rozlokowania",
