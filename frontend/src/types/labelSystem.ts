...
export const LABEL_VARIABLE_CATEGORIES: Array<{
  ...
  },
  {
    ...
    items: [
      ...
      { id: "carrier_code", label: "Kod nośnika", token: "{carrier_code}" },
      { id: "carrier_scan_code", label: "Kod skanu", token: "{carrier_scan_code}" },
      { id: "carrier_barcode", label: "Barcode legacy", token: "{carrier_barcode}" },
      { id: "carrier_name", label: "Nazwa", token: "{carrier_name}" },
      { id: "carrier_group_code", label: "Grupa", token: "{carrier_group_code}" },
      { id: "carrier_location", label: "Lokalizacja bieżąca", token: "{carrier_location}" },
      { id: "carrier_warehouse", label: "Magazyn", token: "{carrier_warehouse}" },
      { id: "barcode_data", label: "Dane QR (barcode_data)", token: "{barcode_data}" },
    ],
  },
  {
    id: "fleet",
