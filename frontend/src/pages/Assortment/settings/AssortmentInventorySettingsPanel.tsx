...
import { WmsSettingsLayout } from "../../Settings/WmsSettingsLayout";
import { WmsSettingsSection } from "../../Settings/WmsSettingsSection";
              ...
              <div className="mt-4 space-y-3" role="radiogroup" aria-label={SCREEN_TITLE}>
                {MODES.map((opt) => (
                  <label key={opt.value} className={radioOuter}>
                    <input
                      type="radio"
                      name="assortment-inventory-management-mode"
