...
export type ZoneConfiguratorHandle = {
  focusForm: () => void;
};

const ZoneConfigurator = forwardRef<
  ZoneConfiguratorHandle,
  {
    zones: Zone[];
    onZoneAdded: () => void;
  }
>(function ZoneConfigurator({ zones, onZoneAdded }, ref) {
  ...
  return (
    <div className="space-y-4">
      <form ref={formCardRef} onSubmit={handleAdd} className={cartsSectionClass} id="zone-floor-form">
