    ...
    <CatalogEntityPageShell flush>
      <ProductEditModal
              ...
              product={{
                ...
                production_trace_batch_mode: p.production_trace_batch_mode,
                production_trace_serial_mode: p.production_trace_serial_mode,
                production_trace_expiry_mode: p.production_trace_expiry_mode,
