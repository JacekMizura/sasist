...
export const wsTokens = {
  ...
  settingsRow:
    "grid w-full max-w-[calc(20rem+15rem+1.25rem)] grid-cols-1 items-start gap-x-5 gap-y-2 border-b border-slate-100 py-4 last:border-b-0 sm:grid-cols-[minmax(12rem,20rem)_minmax(10rem,15rem)]",
  listRow:
