...
export const WMS_SETTINGS_SEARCH_CATALOG: WmsSettingsSearchEntry[] = [
  ...
  e({
    ...
    label: "Wybierz układ",
    tabId: "packing",
    sectionId: "wms-pack-view-mode",
    sectionLabel: "Widok trybu pakowania",
  ...
  e({
    ...
    tabId: "packing",
    sectionId: "wms-pack-orders-list-view",
    sectionLabel: "Widok trybu pakowania - lista zamówień",
  }),
  e({
    id: "packing.start_status_id",
    label: "Status zamówienia do rozpoczęcia pakowania",
    tabId: "packing",
    sectionId: "wms-pack-mode-settings",
    sectionLabel: "Tryb pakowania - ustawienia",
  }),
  e({
  ...
  e({
    ...
    tabId: "packing",
    sectionId: "wms-pack-auto-actions",
    sectionLabel: "Akcje automatyczne",
  }),
  e({
  ...
  e({
    ...
    tabId: "packing",
    sectionId: "wms-pack-packer-warehouse",
    sectionLabel: "Osoba pakująca / magazyn",
  }),
  e({
    id: "packing.require_notes_popup",
    label: "Otwieraj notatki w wyskakującym oknie",
    tabId: "packing",
    sectionId: "wms-pack-notes",
  ...
  e({
    ...
    tabId: "packing",
    sectionId: "wms-pack-sales-document",
    sectionLabel: "Dokument sprzedaży",
  }),
  e({
    id: "packing.enable_multi_parcel",
    label: "Włącz wielopaczkowość",
    tabId: "packing",
    sectionId: "wms-pack-shipments",
    sectionLabel: "Przesyłki / listy przewozowe",
  }),
  e({
  ...
  e({
    ...
    tabId: "packing",
    sectionId: "wms-pack-automation-activators",
    sectionLabel: "Automatyzacja / aktywatory",
  }),
  e({
    id: "packing.go_next_order_after_packed",
    label: "Po spakowaniu zamówienia przejdź do następnego zamówienia",
    tabId: "packing",
    sectionId: "wms-pack-assistant",
    sectionLabel: "Asystent pakowania",
  }),
