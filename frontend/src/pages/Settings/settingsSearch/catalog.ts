...
export const WMS_SETTINGS_SEARCH_CATALOG: WmsSettingsSearchEntry[] = [
  ...
  e({
    id: "direct_sales.allocation_strategy",
    label: "Tryb wydania z lokalizacji",
    tabId: "direct_sales",
    sectionId: "ds-stock",
    sectionLabel: "Stany magazynowe",
    keywords: ["alokacja", "lokalizacja", "wydanie", "podział"],
  }),
  e({
    id: "direct_sales.prefer_store_locations",
    label: "Preferuj lokalizacje sprzedażowe",
    tabId: "direct_sales",
    sectionId: "ds-stock",
    sectionLabel: "Stany magazynowe",
    keywords: ["sklep", "sales", "strefa sprzedaży"],
  }),
  e({
    id: "direct_sales.hide_empty_locations",
