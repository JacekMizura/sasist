...
const PRIMARY_TABS: { id: EditorRightTab; label: string; short: string }[] = [
  ...
  { id: "usage", label: "Przypisania", short: "⊕" },
];
...
export function EditorRightPanel({
  ...
  if (collapsed) {
    return (
      <aside className="flex h-full w-11 flex-col items-center gap-1 border-l border-slate-200 bg-slate-50 py-2">
  ...
  return (
    <aside className="flex h-full min-w-0 flex-col border-l border-slate-200 bg-slate-50">
