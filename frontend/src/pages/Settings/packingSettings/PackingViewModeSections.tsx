...
export function PackingViewModeSections({ extended, draft, patchExtended, toggleInterfaceField }: Props) {
  return (
    <>
      <SectionCard
        id="wms-pack-view-mode"
        title="Widok trybu pakowania"
      ...
      <SectionCard
        id="wms-pack-orders-list-view"
        title="Widok trybu pakowania - lista zamówień"
        summary="Układ i zawartość listy zamówień w trybie pakowania."
      >
        <FieldGrid>
          <SelectField
