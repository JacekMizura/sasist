...
import { fetchWmsConsolidationPlans, type ConsolidationPlanListRow } from "../../../api/wmsConsolidationApi";
...
export default function ConsolidationQueuePage() {
  ...
  const load = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const data = await fetchWmsConsolidationPlans(DAMAGE_TENANT_ID, warehouseId, includeCompleted);
      setRows(data);
    } catch {
      setRows([]);
    } finally {
