...
def finalize_wms_picking_cart(
    ...
    *,
    ...
    try:
        ...
        from .warehouse_wz.constants import FULFILLMENT_KIND_CART, build_fulfillment_key
        ...
        stamp_fulfillment_key_on_pick_movements(
            ...
            fulfillment_key=build_fulfillment_key(
                kind=FULFILLMENT_KIND_CART, session_id=cid
            ),
        )
        logger.info(
...
def finalize_wms_recovery_picking_cart(
    ...
    *,
    ...
    from .warehouse_wz.constants import FULFILLMENT_KIND_RECOVERY, build_fulfillment_key
    from .warehouse_wz.settlement_resolution import stamp_fulfillment_key_on_pick_movements
    ...
    if finalized_ids:
        stamp_fulfillment_key_on_pick_movements(
            ...
            pick_ids=finalized_ids,
            fulfillment_key=build_fulfillment_key(
                kind=FULFILLMENT_KIND_RECOVERY, session_id=int(rt.id)
            ),
        )
