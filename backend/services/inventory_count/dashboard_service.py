...
def _fallback_doc_dict(doc: InventoryDocument) -> dict[str, Any]:
    ...
    return {
        ...
        "lock_mode": str(getattr(doc, "lock_mode", "allow_operations") or "allow_operations"),
        "movement_policy": str(getattr(doc, "lock_mode", "allow_operations") or "allow_operations"),
        "result_policy": "update_stock",
