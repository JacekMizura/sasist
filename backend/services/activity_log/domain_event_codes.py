...
# Warehouse-level business reservation (RZ)
ORDER_WAREHOUSE_RZ_CREATED = "ORDER_WAREHOUSE_RZ_CREATED"
ORDER_WAREHOUSE_RESERVATION_CREATED = "ORDER_WAREHOUSE_RESERVATION_CREATED"
ORDER_WAREHOUSE_RESERVATION_RELEASED = "ORDER_WAREHOUSE_RESERVATION_RELEASED"
ORDER_WAREHOUSE_RESERVATION_CONSUMED = "ORDER_WAREHOUSE_RESERVATION_CONSUMED"

# WZ lifecycle (Phase 2)
ORDER_WZ_DOCUMENTARY_CREATED = "ORDER_WZ_DOCUMENTARY_CREATED"
ORDER_WZ_ISSUE_CREATED = "ORDER_WZ_ISSUE_CREATED"
...
DOMAIN_EVENT_TITLES_PL: dict[str, str] = {
    ...
    ORDER_WAREHOUSE_RZ_CREATED: "Utworzono dokument rezerwacji",
    ORDER_WAREHOUSE_RESERVATION_CREATED: "Zarezerwowano towar",
    ORDER_WAREHOUSE_RESERVATION_RELEASED: "Zwolniono rezerwację",
    ORDER_WAREHOUSE_RESERVATION_CONSUMED: "Zrealizowano rezerwację",
    ORDER_WZ_DOCUMENTARY_CREATED: "Utworzono dokument WZ (potwierdzenie wydania)",
    ORDER_WZ_ISSUE_CREATED: "Utworzono i zrealizowano dokument WZ",
}
