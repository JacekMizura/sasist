...
class DirectSaleSession(Base):
    ...
    document_subtype = Column(String(16), nullable=False, default="RECEIPT")
    order_discount_type = Column(String(16), nullable=True)
    order_discount_value = Column(Float, nullable=False, default=0.0)
