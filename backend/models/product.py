...
class Product(Base):
    ...
    require_recv_width = Column(Boolean, nullable=False, default=False, server_default=text("false"))
    require_recv_length = Column(Boolean, nullable=False, default=False, server_default=text("false"))
    require_recv_weight = Column(Boolean, nullable=False, default=False, server_default=text("false"))
    require_recv_master_carton = Column(Boolean, nullable=False, default=False, server_default=text("false"))
    require_recv_master_carton_ean = Column(Boolean, nullable=False, default=False, server_default=text("false"))
    require_recv_master_carton_qty = Column(Boolean, nullable=False, default=False, server_default=text("false"))
