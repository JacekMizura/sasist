...
DOCUMENT_TYPE_TO_PRINT_PROFILE: Final[dict[str, str]] = {
    ...
    "production_batch_material_pick_list": PRINT_PROFILE_DOCUMENTS,
    "production_order_material_pick_list": PRINT_PROFILE_DOCUMENTS,
    "production_card": PRINT_PROFILE_DOCUMENTS,
    "production_material_pick_list": PRINT_PROFILE_DOCUMENTS,
